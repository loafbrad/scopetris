...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__hf2a29f4adf7ec8a6: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h18a03829a2dff87a: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2b2a95d8d9c9d6b7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2b2a95d8d9c9d6b7_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1a65ab3bd3854cf9: (a: number, b: number) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h04c4b132eca9c1c2: (a: number, b: number) => void;
